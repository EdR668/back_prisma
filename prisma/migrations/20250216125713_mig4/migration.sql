/*
  ...
  - Added the required column `id` to the `Landlord` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "Landlord" ADD COLUMN     "id" INTEGER NOT NULL;
